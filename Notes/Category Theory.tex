...
\begin{defi} (4.4)\\
    ...
    From some later parts of the notes, the definitions of these three words (\emph{preserve, reflect, create} seem to apply to other things as well and not only restricted to limits).
\end{defi}
