...
\begin{defi} (4.14)\\
    ...
    \begin{tikzcd}
        ...
        & A &
    \end{tikzcd}
    i.e. there a factorization of $A''$ through $A'$.\\
...
\begin{thm} (4.16, Special AFT)\\
    ...
    \begin{proof}
        $\implies$: by (4.9).\\
        $\Leftarrow$: For any $A \in \ob\mathcal{C}$, $(A \downarrow G)$ is complete by (4.10), locally small, and well-powered since the subobjects of $(B,f)$ in $(A\downarrow G)$. But they are just those subobjects $B' \rightarrowtail B$ in $\mathcal{D}$ for which $f$ factors through $GB' \rightarrowtail GB$.\\
