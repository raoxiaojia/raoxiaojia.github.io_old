...
\begin{defi} (4.1)\\
    ...
    with 4 objects and 5 non-identity morphisms, a diagram of shape $\mathcal{J}$ is a commutaitve square
    ...
    If $\mathcal{J}$ is 
    \begin{tikzcd}
        \cdot \arrow[r] \arrow [dr] \arrow[dr, shift right] \arrow [d] & \cdot \arrow[d]\\
        \cdot \arrow[r] & \cdot
    \end{tikzcd}
