...
---two lectures (19,20) to be transcribed---
...
\begin{defi} (7.1)\\
    ...
    (c) If $\mathcal{E}$ and $\exists$ are toposes, a \emph{logical functor} $F:\mathcal{E} \to \exists$ is one which preserves finite limits, exponentials and the subobject classifier.
\end{defi}
