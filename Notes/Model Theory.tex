...
\begin{defi} (3.1)\\
    An \emph{$\mathcal{L}$-theory} $T$ is a set of $L$-sentences.\\
    ...
    \begin{equation*}
        \begin{aligned}
            Th(\mathcal{M}) = \{\sigma:\sigma \text{ is an } L-\text{structure and } \mathcal{M} \vDash \sigma\}
        \end{aligned}
    \end{equation*}
\end{defi}
...
\begin{defi} (3.3)\\
    ...
    We'll see $(\mathcal{Q},<) \equiv (\mathcal{R},<)$ as $L_{lo}-$structures(!).
\end{defi}
