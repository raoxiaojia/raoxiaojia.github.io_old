...
\begin{proof} (4.18)\\
    Let $\mathcal{M},\mathcal{N} \vDash T_{rg}$ and $|\mathcal{M}| = |\mathcal{N}| = \omega$, adnd $P:A \subseteq M \to N$ is a finite partial embedding.\\
...
\begin{lemma} (5.3)\\
    ...
    \begin{proof}
        ...
        $$R(\bar{c}) \in T \iff R(\mathbf{d}) \in T$$
        ...
        $\bullet$ $\implies$: by induction on the complexity of $T$ (lecturer decidse to leave this as another exercise).\\
