...
\begin{proof}
Let $\rho:G \to GL(V)$ be faithful irreducible complex representation. Let $z \in Z(G)$, so $zg = gz$ $\forall g \in G$, hence the map $\phi_z: v \to zv$ ($v \in V$) is $G$-endomorphism of $V$, hence is multiplication by scalar $\mu_z$, say.\\
