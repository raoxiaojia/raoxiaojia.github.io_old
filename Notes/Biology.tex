...
\end{aligned}
\end{equation*}
This is our model when $p=2$.

We'll try to simplify these equations. By rescaling the time as $t \to rt$, nd rescaling the population as $n \to \frac{\varepsilon}{r} n$, we get
\begin{equation*}
\begin{aligned}
